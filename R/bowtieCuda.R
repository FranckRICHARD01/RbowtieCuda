...
nvBowtie_usage <- function() {
    ...
    print("  --nofw                        [false]    do not align the forward strand")
    print("  --norc                        [false]    do not align the reverse-complemented strand")
    print("  --device            int       [0]        select the given cuda device(s) (e.g. --device 0 --device 1 ...)")
    print("  --file-ref                    [false]    load reference from file")
    print("  --server-ref                  [false]    load reference from server")
    print("  --phred33                     [true]     qualities are ASCII characters equal to Phred quality + 33")
    print("  --phred64                     [false]    qualities are ASCII characters equal to Phred quality + 64")
    print("  --solexa-quals                [false]    qualities are in the Solexa format")
    ...
    print("Paired-End:")
    print("  --ff                          [false]    paired mates are forward-forward")
    print("  --fr                          [true]     paired mates are forward-reverse")
    print("  --rf                          [false]    paired mates are reverse-forwardd")
    print("  --rr                          [false]    paired mates are reverse-reverse")
    print("  --minins            int       [0]        minimum insert length")
    print("  --maxins            int       [500]      maximum insert length")
    print("  --overlap                     [true]     allow overlapping mates")
    #print("  --no-discordant               [false]    do not allow discordant mates")
    print("  --no-mixed                    [false]    only report paired alignments")
    ...
    print("  --top               bool      [false]    explore top seed entirely")
    print("  --N                 bool      [false]    allow substitution in seed")
    print("Extension:")
    print("  --all        | -a             [false]    perform all-mapping (i.e. find and report all alignments)")
    print("  --local                       [false]    perform local alignment")
    print("  --rand                        [true]     randomized seed hit selection")
    print("  --no-rand                     [false]    do not randomize seed hit selection")
    ...
    print("Scoring:")
    print("  --scoring           {sw|ed}  [ed]        Smith-Waterman / Edit-Distance scoring")
    ...
    print("")
    print("")
    print("Default values are indicated in brackets [].")
}
